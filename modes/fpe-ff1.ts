...
// --- AES-FPE (Format-Preserving Encryption, modo FF1 - NIST SP 800-38G) ---
/**
 * Implementación de AES-FPE en modo FF1, conforme a NIST SP 800-38Gr1.
 * @see https://doi.org/10.6028/NIST.SP.800-38Gr1.2pd
 */
